Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/shiverware/DRCollectionViewTableLayout-iOS'
  s.license      = { :type => 'MIT', :file => 'LICENSE' }
  s.author       = { 'Dariusz Rybicki' => 'darrarski@gmail.com' }
  s.source       = { :git => 'https://github.com/shiverware/DRCollectionViewTableLayout-iOS.git', :tag => '1.0.6' }
  s.platform     = :ios
